...
<div class="de-event-grid" aria-label="Upcoming Digital Edge events">
  ...
  <button
    ...
    type="button"
    data-event-filter-key="masterclass"
    data-event-title="The AI Shift: What Every Professional Needs to Know"
    data-event-type="Masterclass"
    data-event-status="Upcoming"
    data-event-date="Friday 12 December 2026"
    data-event-time="12:00-13:00"
    data-event-start="2026-12-12T12:00:00+00:00"
    data-event-end="2026-12-12T13:00:00+00:00"
    data-event-location="Online"
    data-event-description="From ChatGPT to copilots and beyond, this session gives a strategic overview of AI's rise, the risks, and the opportunities. Ideal for professionals looking to stay relevant and lead in an AI-first world."
    data-event-audience="Learners and apprentices who want a strategic overview of AI, its risks, and its opportunities for professional development."
  >
    <div class="de-event-tags">
      <span class="de-event-type de-event-type--masterclass">Masterclass</span>
      <span class="de-event-status de-event-status--upcoming">Upcoming</span>
    </div>
    <strong>The AI Shift: What Every Professional Needs to Know</strong>
    <span>Friday 12 December 2026 · 12:00-13:00</span>
...
<div class="de-event-grid" aria-label="Past Digital Edge events">
  ...
  <button
    ...
    data-event-takeaways="Quantum readiness belongs in technology strategy, not only security operations.|Teams should identify where encryption is used before choosing migration paths.|Post-quantum planning is a staged change programme, not a single tooling decision."
  >
    <div class="de-event-tags">
      <span class="de-event-type de-event-type--masterclass">Masterclass</span>
      <span class="de-event-status de-event-status--past">Past</span>
...
<div class="de-event-archive" aria-label="Past event resources and key takeaways">
  <article>
    <span class="de-card__label">Resource archive</span>
    <h3>Post-Quantum World: Is Your Cybersecurity Ready</h3>
    <p>Key takeaways are ready to grow into a fuller resource pack when slides, recordings, or follow-up links are available.</p>
    <ul>
      <li>Quantum readiness belongs in technology strategy, not only security operations.</li>
      <li>Teams should identify where encryption is used before choosing migration paths.</li>
      <li>Post-quantum planning is a staged change programme, not a single tooling decision.</li>
    </ul>
  </article>
</div>
</section>
