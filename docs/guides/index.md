...
<div class="de-card-grid de-card-grid--guide-section">
  <a class="de-card" href="agile-waterfall/">
...
Focus on the everyday behaviours that make technical work easier to share, review, continue, and improve.

<div class="de-card-grid de-card-grid--guide-section">
  <a class="de-card" href="time-management/">
    <span class="de-card__label">Work habits</span>
    <h3>Time Management</h3>
    <p>Break technical work down, make uncertainty visible, and protect time for review.</p>
  </a>
  <a class="de-card" href="technical-notes/">
    <span class="de-card__label">Work habits</span>
...
Explore the shared practices teams use to work on technical projects without losing context, quality, or trust.
...
Learn how teams check work, improve it safely, and give feedback that is useful rather than vague.
...
Understand the systems and hosting choices that sit underneath digital products, services, and workplace tools.

<div class="de-card-grid de-card-grid--guide-section">
  <a class="de-card" href="cloud-vs-on-prem/">
...
Use clearer language for diagnosing issues, reporting problems, and separating what happened from why it happened.

<div class="de-card-grid de-card-grid--guide-section">
  <a class="de-card" href="incidents-bugs-problems/">
...
Slow down before choosing a tool, solution, or process change, and ask better questions first.

<div class="de-card-grid de-card-grid--guide-section">
  <a class="de-card" href="technical-judgement/">
