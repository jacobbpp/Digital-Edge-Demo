...
<div class="de-path-summary">
  <div>
    <span>Purpose</span>
    <strong>Keep curriculum current</strong>
  </div>
  <div>
    <span>Format</span>
    <strong>Short case studies</strong>
  </div>
  <div>
    <span>Use</span>
    <strong>Discussion and reflection</strong>
  </div>
</div>
...
More software, cyber, IT, and marketing trending topics can be added here as new cards.
