...
<section class="de-profile-hero">
  <div>
    ...
    <h1>Matt Lucas</h1>
    <p class="de-profile-role">Associate Professor of Technology, BPP University</p>
    <p>Matt leads the AI and machine learning programmes at BPP University, and writes about the implications of AI adoption within organisations, particularly the effect AI is having on teaching, learning, and skills.</p>
  </div>
</section>
...
<div class="de-subject-tags" aria-label="Subject areas">
  ...
  <span>IT skills formation</span>
  <span>Ethical technology adoption</span>
</div>

## Biography

Matthew Lucas, known as Matt, brings over 25 years of prior IT industry experience. He helped multinational enterprise clients understand, evaluate, and adopt new technology, including AI, blockchain, and systems integration middleware.
